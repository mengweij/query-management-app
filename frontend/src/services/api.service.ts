...
export const apiService = {
    ...
    query: {
        create: (data: CreateQueryDto) => handleRequest<Query>(api.post('/queries', data)),
        updateStatus: (id: string, status: 'RESOLVED') => handleRequest<Query>(api.patch(`/queries/${id}`, { status })),
